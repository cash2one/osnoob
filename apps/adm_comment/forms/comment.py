...
from wtforms import  SelectField, SubmitField, BooleanField, HiddenField, StringField, ValidationError
from wtforms.validators import Required, Length

__author__ = 'woo'
class CommentSelectForm(Form):

    q = SelectField(coerce=str)
    submit = SubmitField('选择')

    def __init__(self, *args, **kwargs):
        super(CommentSelectForm, self).__init__(*args, **kwargs)
        self.q.choices = [('all', u'全部'),('been', u'已发表'),('audit', u'待审核'),('auto_audit', u'已自动审核'),
                          ('unqualified', u'未通过'),('deleted', u'回收站')]
